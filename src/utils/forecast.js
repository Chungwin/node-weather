...
const forecast = (longitude, latitude, callback) => {
    ...
    request({ url, json: true }, (error, { body }) => {
        ...
        if (error) {
            ...
            callback(undefined, 'It is ' + body.current.weather_descriptions[0] + '. The temperature is '+ body.current.temperature + ' degrees Fahrenheit. It feels like ' + body.current.feelslike + ' degrees Fahrenheit. The humidity is ' + body.current.humidity + '%.')
        }
    })
}
